<?php
$pageTitle = "Report Found Item | Lost & Found";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($description) || empty($category) || empty($location) || empty($date_found)) {
        ...
        $stmt = $conn->prepare("INSERT INTO found_items (user_id, title, description, category, location, date_found, image_path) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("issssss", $user_id, $title, $description, $category, $location, $date_found, $image_path);
        ...
        <div class="col-lg-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="bi bi-bag-check"></i> Report Found Item</h5>
                </div>
                <div class="card-body">
                    <?php if ($success): ?>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Upload a clear photo of the found item (JPG, PNG, GIF)</div>
                        </div>
